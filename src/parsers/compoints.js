      ...
      try {
        ...
        await new Promise((resolve) => {
            ...
            for(let mStack in data.Matches) {
             ...
             if(m.MatchID) {
               parsed.push({ "MatchStartTime":date, "Tier After Update":m.TierAfterUpdate, "Tier Before Update":m.TierBeforeUpdate, "Tier Progress After Update":m.TierProgressAfterUpdate, "Tier Progress Before Update":m.TierProgressBeforeUpdate,  "CompetitiveMovement":m.CompetitiveMovement });
               length--;
             }
